...
import { addItem, clearItems, minusItem, removeItem, selectCart } from '../../redux/slices/CartSlice';
            ...
            <div className="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                <div className="m-l-25 m-r--38 m-lr-0-xl">
                                ...
                                items.map((item: any) => (
                                    <tr className="table_row">
                                        <td className="column-1">
                                            <div onClick={() => onClickRemove(item.id)} className="how-itemcart1">
                                        ...
                                        <td className="column-4">
                                            <div className="wrap-num-product flex-w m-l-auto m-r-0">
                                                {item.count > 1 ? <div onClick={() => onClickMinus(item.id)} className="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
                                                    <i className="fs-16 zmdi zmdi-minus"></i>
                                                </div> : <div className="btn-num-product-down cl8 trans-04 flex-c-m">
                                                    <i className="fs-16 zmdi zmdi-minus"></i>
                                                </div>}

                                                <input className="mtext-104 cl3 txt-center num-product" type="number" name="num-product2" value={item.count} />

                                                <div onClick={() => onClickPlus(item.id)} className="btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m">
                                                    <i className="fs-16 zmdi zmdi-plus"></i>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="column-5">$ {Math.round(item.price * item.count)}</td>
                                    </tr>
                                ))
                            }
                        </table>
                    ...
                    <div className="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                        ...
                        <div onClick={() => onClickClear()} className="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10">
                            Clear Cart
                        </div>
                    </div>
                </div>
                        ...
                        <div className="size-209 p-r-18 p-r-0-sm w-full-ssm">
                            ...
                            <div className="p-t-15">
                                ...
                                <div className="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                                    <input className="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="state" placeholder="Select a country..." />
